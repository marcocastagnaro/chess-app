...
public class Connector {
    ...
    public static Movement toMovement(Move move, Board board){
        ...
        Common.Position fromPosition = board.getPosition(move.getFrom().getRow() -1 , move.getFrom().getColumn() -1 );
        Common.Position toPosition = board.getPosition(move.getTo().getRow() -1 , move.getTo().getColumn() -1 );
